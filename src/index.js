...
list.addProjectToList("Kitchen renovation", "2024-12-31", "high", "Start with painting the walls")
...
list.addProjectToList("Garden redesign", "2025-03-15", "medium", "Focus on the backyard first")
...
list.addProjectToList("Home office setup", "2025-01-31", "high", "Need to be done before Q1")
